...
reponse_ten = "1" # Quiero que se cree un punto de referencia automatico para el hiper volumen
    ...
    for evaluation in evaluations:
        for seed in seeds:
            ...
            if problem == "ZDT3":
                ...
                response_seven = "results/NSGAII/"+ problem +"/EVAL" + str(iterations) + "/P" + str(population) + "G" + str(generations) + "/allpopm_seed" + str(seed) + ".out" # Ruta del segundo archivo
